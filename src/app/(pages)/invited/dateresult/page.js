...
//                 <button className="flex w-[282px] h-[64px] px-16 justify-center items-center rounded-full bg-green-100">이전</button>
//                 <button className="flex w-[282px] h-[64px] px-16 justify-center items-center rounded-full bg-green-600 text-white">등록하기</button>
//             </div>
//           </div>
